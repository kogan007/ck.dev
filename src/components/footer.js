...
const Footer = () => {
    return (
    <section className="mt-auto w-full bg-gray-700">
                ...
                <div className="box-border text-base text-gray-500">
                    ...
                    <ul className="p-0 m-0 text-base leading-tight list-none">
                        <li className="box-border py-2 text-sm font-normal text-left text-gray-500 md:text-base md:mb-1">
                            <Link to="/" className="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400">Home</Link>
                        </li>
                        <li className="box-border py-2 text-sm font-normal text-left text-gray-500 md:text-base md:mb-1">
                            <Link to="/blog" className="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400">Blog</Link>
                        </li>
        ...
        <div className="flex flex-col items-center justify-between w-full py-12 text-xs leading-none text-gray-500 border-t border-gray-800 lg:flex-row">
            <div className="flex self-start flex-grow-0 flex-shrink-0 w-full leading-none lg:w-auto">
                <span className="inline-flex justify-center w-full mt-4 space-x-5 sm:ml-auto sm:mt-0">
                    <a href="https://www.facebook.com/corey.kogan" className="text-gray-400 hover:text-gray-200">
                    ...
                    <a href="https://instagram.com/coreykogan" className="text-gray-400 hover:text-gray-200">
                    ...
                    <a href="https://github.com/kogan007" className="text-gray-400 hover:text-gray-200">
            ...
            <p className="block m-0 text-base font-semibold text-gray-500">
                Copyright © {new Date().getFullYear()} Corey Kogan
            </p>
        </div>
        </div>
